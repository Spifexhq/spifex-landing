...
export default function ProductsMegaMenu() {
  ...
  const menuPanel = (
    ...
    >
      {/* Anchored to viewport now */}
      <div
        className="fixed left-1/2 top-16 z-50 w-[min(80rem,calc(100vw-1.5rem))] sm:w-[min(80rem,calc(100vw-2rem))] -translate-x-1/2 pointer-events-none"
        role="menu"
      >
        <div
          className="
