const ptBR = {
  ...
  pricingTiers: {
    free: {
      name: "Free",
      priceLabel: "Grátis",
      description: "Para pessoas e equipes muito pequenas que estão começando a estruturar a operação financeira.",
      highlights: {
        0: "Acesso básico ao workspace",
        1: "Visibilidade básica de cashflow",
        2: "Fluxo padrão de onboarding",
        3: "Comece sem forma de pagamento",
      },
      ctaLabel: "Começar",
    },
    starter: {
      name: "Starter",
      description: "Para equipes em crescimento que precisam de mais estrutura, controle operacional e rotinas recorrentes.",
      highlights: {
        0: "Planejamento e execução de cashflow",
    ...
    pro: {
      name: "Pro",
      description: "Para equipes financeiras que exigem mais governança, automação e escala.",
      highlights: {
        0: "Workflows operacionais avançados",
        1: "Governança, controles e auditabilidade",
        2: "Projetos, departamentos e relatórios mais robustos",
    ...
    features: {
      ...
      items: {
        moneyLifecycle: {
          ...
          desc: "De movimentos planejados a liquidações, transferências e conciliação. Tudo unificado de ponta a ponta.",
        },
        complexity: {
